    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-blue-900 mb-6">
          Secure <span className="text-blue-600">Group Savings</span> Made
          Simple
        </h1>
        <p className="text-lg md:text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
          Modern digital protection for traditional rotating savings schemes.
          Save with confidence, no matter where your members are located.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/dashboard"
            className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-md font-bold text-lg transition duration-300"
          >
            Start Your Group
          </Link>
          <Link
            href="#how-it-works"
            className="border-2 border-blue-600 text-blue-700 hover:bg-blue-50 px-8 py-3 rounded-md font-bold text-lg transition duration-300"
          >
            Learn More
          </Link>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-blue-50 rounded-lg p-6 hover:shadow-lg transition duration-300">
              ...
              <p className="text-gray-700 text-center">
                Funds held securely in escrow until payout time. No more worries
                about leaders running away with group money.
              </p>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6 hover:shadow-lg transition duration-300">
              ...
              <p className="text-gray-700 text-center">
                Connect with trustworthy members worldwide, not just in your
                local community.
              </p>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6 hover:shadow-lg transition duration-300">
              ...
              <p className="text-gray-700 text-center">
                Perfect for communities and faiths that avoid interest-based
                financial systems.
              </p>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6 hover:shadow-lg transition duration-300">
              ...
              <p className="text-gray-700 text-center">
                Fair, transparent scheduling of payouts with no manual work
                required.
              </p>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6 hover:shadow-lg transition duration-300">
              ...
              <p className="text-gray-700 text-center">
                Member ratings and verification systems create accountability
                and reliability.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Gather 5 members who agree to contribute a fixed amount
                      (like 100₵) each period.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Decide on contribution frequency (weekly, monthly) and
                      payment order.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Each period, one member receives the full pot (500₵) until
            ...
            <div className="lg:w-1/2 bg-blue-600 text-white rounded-lg p-8">
              ...
              <p className="mb-4">
                Just like people now trust strangers through Airbnb and
                ride-sharing, Group Susu brings that same innovation to
                community finance.
              </p>
              <p>
      ...
      <section className="py-16 bg-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link
            href="/dashboard"
            className="inline-block bg-white text-blue-700 hover:bg-blue-50 px-8 py-3 rounded-md font-bold text-lg transition duration-300"
          >
            Get Started Now
          </Link>
        </div>
